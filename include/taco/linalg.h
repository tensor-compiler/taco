...
template<typename CType>
Matrix<CType>::Matrix(std::string name, std::vector<int> dimensions) : LinalgBase(name,
                                                                                  Type(type<CType>(), dimensions)) {}
...
public:
  ...
  Vector(std::string name, int dim, Format format, bool isColVec = true);

  Vector(std::string name, int dim, ModeFormat format, bool isColVec = true);
...
template<typename CType>
Vector<CType>::Vector(std::string name, int dim, bool isColVec) : LinalgBase(name, Type(type<CType>(), {dim}),
                                                                             isColVec) {}

template<typename CType>
Vector<CType>::Vector(std::string name, int dim, Format format, bool isColVec) : LinalgBase(name,
                                                                                            Type(type<CType>(), {dim}),
                                                                                            format, isColVec) {}

template<typename CType>
Vector<CType>::Vector(std::string name, int dim, ModeFormat format, bool isColVec) :
