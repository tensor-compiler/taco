...
INSTANTIATE_TEST_CASE_P(parallelize, apply,
                        Values(
                                TransformationTest(Parallelize(i),
                                                   forall(i, w(i) = b(i)),
                                                   forall(i, w(i) = b(i), ParallelUnit::DefaultUnit, OutputRaceStrategy::NoRaces, {}, TensorVar())
                                ),
                                TransformationTest(Parallelize(i),
                                                   forall(i, forall(j, W(i,j) = A(i,j))),
                                                   forall(i, forall(j, W(i,j) = A(i,j)), ParallelUnit::DefaultUnit, OutputRaceStrategy::NoRaces, {}, TensorVar())
                                ),
...
INSTANTIATE_TEST_CASE_P(misc, reorderLoopsTopologically, Values(
  ...
  NotationTest(forall(i, w(i) = b(i), ParallelUnit::DefaultUnit, OutputRaceStrategy::NoRaces, {}, TensorVar()),
                  forall(i, w(i) = b(i), ParallelUnit::DefaultUnit, OutputRaceStrategy::NoRaces, {}, TensorVar())),
