...
INSTANTIATE_TEST_CASE_P(parallelize, apply,
                        Values(
                                TransformationTest(Parallelize(i),
                                                   forall(i, w(i) = b(i)),
                                                   forall(i, w(i) = b(i), PARALLEL_UNIT::DEFAULT_UNIT, OUTPUT_RACE_STRATEGY::NO_RACES)
                                ),
                                TransformationTest(Parallelize(i),
                                                   forall(i, forall(j, W(i,j) = A(i,j))),
                                                   forall(i, forall(j, W(i,j) = A(i,j)), PARALLEL_UNIT::DEFAULT_UNIT, OUTPUT_RACE_STRATEGY::NO_RACES)
                                ),
...
INSTANTIATE_TEST_CASE_P(misc, reorderLoopsTopologically, Values(
  ...
  NotationTest(forall(i, w(i) = b(i), PARALLEL_UNIT::DEFAULT_UNIT, OUTPUT_RACE_STRATEGY::NO_RACES),
                  forall(i, w(i) = b(i), PARALLEL_UNIT::DEFAULT_UNIT, OUTPUT_RACE_STRATEGY::NO_RACES)),
